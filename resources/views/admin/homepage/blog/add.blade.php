                            ...
                            <form action="{{route('add_blog_action')}}" enctype="multipart/form-data" method="post">
                                ...
                                <div class="row p-4">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input class="form-control mb-4" value="{{old('type')}}" placeholder="Blog Type" type="text" name="type">
                                        @error('type')
                                        <span class="text text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-46 mb-3">
                                        <label><strong>Author Name:</strong></label>
                                        <input class="form-control mb-4" value="{{old('author_name')}}" placeholder="Author Name" type="text" name="author_name">
                                        @error('author_name')
                                        <span class="text text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
