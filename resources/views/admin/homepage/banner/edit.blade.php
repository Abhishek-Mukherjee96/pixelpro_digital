                                ...
                                <form action="{{route('edit_banner_action',$edit_banner->id)}}" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <img src="{{asset('public/admin/assets/banner/'.$edit_banner->image)}}" class="img-responsive" width="75px">
                                            @error('image')
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea placeholder="Description" class="form-control mb-4" name="description">{{$edit_banner->description}}</textarea>
                                            @error('description')
                                            <span class="text text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
