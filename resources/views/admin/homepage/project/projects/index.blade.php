                ...
                <div class="page-header">
                    ...
                    <div class="page-rightheader">
                        <div class="btn btn-list">
                            <a href="{{route('add_project')}}" class="btn btn-info"><i class="fe fe-plus mr-1"></i>Add</a>
                        </div>
                    </div>
                </div>
                <!--End Page header-->
                                        ...
                                        <table id="example1" class="table table-bordered text-nowrap key-buttons">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="wd-15p border-bottom-0">Project Type</th>
                                                    <th class="wd-15p border-bottom-0">Image</th>
                                                    <th class="wd-15p border-bottom-0">Project Category</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{asset('public/admin/assets/project/'.$list->image)}}" width="75px">
                                                    </td>
                                                    <td>{{$list->name}}</td>
                                                    <td>
                                                        @if($list->status == '1')
