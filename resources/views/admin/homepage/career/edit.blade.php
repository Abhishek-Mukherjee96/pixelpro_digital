                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <form action="{{route('update_career',$career->id)}}" enctype="multipart/form-data" method="post">
                                @csrf
                                <div class="row p-4">
                                    <div class="col-md-4 mb-3">
                                        <label><strong>Title:</strong></label>
                                        <input class="form-control mb-4" value="{{$career->title}}" placeholder="Title" type="text" name="title">
                                        @error('title')
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-control" name="tab_name">
                                            ...
                                            <option value="{{$list->tab_name}}" {{ $list->tab_name == $career->tab_name ? 'selected' : '' }}>{{$list->tab_name}}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                        @error('tab_name')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control mb-4" value="{{$career->location}}" placeholder="Location" type="text" name="location">
                                        @error('location')
                                        <span class="text text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
