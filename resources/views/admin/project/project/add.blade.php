                                ...
                                <form action="{{route('add_project_action')}}" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input class="form-control mb-4" value="{{old('business_name')}}" placeholder="Business Name" type="text" name="business_name">
                                            @error('business_name')
                                            <span class="text text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input class="form-control mb-4" value="{{old('client_name')}}" placeholder="Client Name" type="text" name="client_name">
                                            @error('client_name')
                                            <span class="text text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" name="project_doc_file" accept=".pdf,.doc">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input class="form-control mb-4" value="{{old('website_url')}}" placeholder="Website URL" type="text" name="website_url">
                                        </div>
                                        <div class="col-md-12 mb-3">
                                            <label><strong>Description:</strong></label>
                                            <textarea class="content mb-4" rows="2" placeholder="Description" name="description">{{old('description')}}</textarea>
                                        </div>
                                        <div class="col-md-12">
