...
<script src="{{asset('public/admin')}}/assets/plugins/fullcalendar/moment.min.js"></script>
<script src="{{asset('public/admin')}}/assets/plugins/fullcalendar/fullcalendar.min.js"></script>
<script src="{{asset('public/admin')}}/assets/js/app-calendar-events.js"></script>
<script src="{{asset('public/admin')}}/assets/js/app-calendar.js"></script>
