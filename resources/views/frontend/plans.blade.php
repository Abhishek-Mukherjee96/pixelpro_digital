...
<title>Plans - Pixel Pro Digital</title>
<div class="inner-banner" style="
  ...
  <div class="container">
    <div class="row d-flex justify-content-center align-items-center text-center">
      <div class="col-md-6">
        <h2 class="inner-banner-title wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".2s">Our Plans</h2>
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb gap-3">
            <li class="breadcrumb-item"><a href="index-2.html">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">Our Plans</li>
          </ol>
        </nav>
      </div>
    </div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-10">
        <div class="portfolio-item1 wow fadeInDown" data-wow-duration="1.5s" data-wow-delay="0.2s">
          <div class="portfolio-img">
            <img alt="image" src="{{asset('public/admin/assets/plan/'.$list->image)}}">
          </div>
          <div class="portfolio-content">
            <span><a href="{{url('plans-details/'.@$list->slug)}}"> {{$list->name}}</a></span>
            <p><a href="{{url('plans-details/'.@$list->slug)}}">{{$list->short_desc}}</a></p>
            <a href="{{url('plans-details/'.@$list->slug)}}" class="text-btn">Live Preview<svg width="18" height="10" viewBox="0 0 18 10" xmlns="http://www.w3.org/2000/svg">
