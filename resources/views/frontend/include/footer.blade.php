            ...
            <div class="row gy-5">
                <div class="col-lg-3 col-md-6">
                    <div class="footer-item">
                        <a href="index-2.html"><img alt="image" src="{{asset('public/admin/assets/logo/'.$footer->logo)}}" /></a>
                        <p>
                        {!!$footer->description!!}
                        </p>
                        <form>
                    ...
                    <div class="footer-item">
                        ...
                        <ul class="address-list">
                            ...
                            <li>
                                ...
                                <a href="tel:+8801761456456">{{$footer->phone}}</a>
                            </li>
                            <li>
                                <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#b4dddad2dbf4d1ccd5d9c4d8d19ad7dbd9"><span class="__cf_email__" data-cfemail="4821262e27082d30292538242d662b2725">{{$footer->email}}</span></a>
                            </li>
                        </ul>
